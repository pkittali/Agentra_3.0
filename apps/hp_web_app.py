...
from pages.web.special_offer_page import SpecialOffersPage
from pages.web.deep_link_page import DeepLinkPage
from pages.web.continue_enroll import EnrollmentPage
...
class HPAppWeb:
    ...
    def __init__(self, driver, config):
        ...
        self.deep_link_page=DeepLinkPage(driver)
        self.continue_enroll=EnrollmentPage(driver)
    ...
    def apply_promo_code(self):
        self.special_offers_page.open_enter_promo_prompt()
        self.special_offers_page.enter_promo_code("PROMO123")
        self.special_offers_page.click_apply()
        self.special_offers_page.get_apply_success_msg()
        self.special_offers_page.click_close_modal()

    def deep_link_pages(self):
        self.deep_link_page.verify_deeplink_page_loaded()
